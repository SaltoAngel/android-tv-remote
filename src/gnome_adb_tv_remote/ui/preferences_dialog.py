...
ACTION_TO_KEYCODE: dict[str, str] = {
    ...
    "color-red": "KEYCODE_PROG_RED",
    "color-green": "KEYCODE_PROG_GREEN",
    "color-yellow": "KEYCODE_PROG_YELLOW",
    "color-blue": "KEYCODE_PROG_BLUE",
...
ACTION_CATEGORIES: dict[str, list[str]] = {
    ...
    "Media": ["play-pause", "previous", "next", "rewind", "fast-forward"],
    "Color Buttons": ["color-red", "color-green", "color-yellow", "color-blue"],
